...
const Forecast1 = () => {
  ...
  const handleFetchForecast = async () => {
    setLoading(true);
    try {
      const response = await axios.post('http://localhost:8080/forecast1', {
        ticker,
        end_date: endDate,
      ...
      <div className="forecast-calculator-left">
        ...
        <div className="multi-fields">
          ...
          <select onChange={(e) => setTicker(e.target.value)}>
            <option value=""></option>
            <option value="AAPL">BTC-USD</option>
            <option value="MSFT">ETH-USD</option>
            <option value="AMZN">USDT-USD</option>
            <option value="GOOGL">BNB-USD</option>
            <option value="NVDA">SOL-USD</option>
          </select>
        </div>
        <div className="multi-fields">
